	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			this.state.openOptions && _react2.default.createElement(
				...
				(this.state.filter ? Object.keys(this.state.filteredCountries).sort(function (a, b) {
					return _this4.state.filteredCountries[a] - _this4.state.filteredCountries[b];
				}) : Object.keys(this.state.countries).sort(function (a, b) {
					return _this4.state.countries[a] - _this4.state.countries[b];
